...
-- Migration user
CREATE ROLE cl_migrate WITH LOGIN PASSWORD '<MIGRATION USER PASSWORD>' NOSUPERUSER NOCREATEDB NOCREATEROLE;
...
CREATE ROLE cl_api WITH LOGIN PASSWORD '<API USER PASSWORD>';
GRANT cl_rw TO cl_api;
ALTER ROLE cl_api SET search_path TO app;

CREATE ROLE cl_auth WITH LOGIN PASSWORD '<AUTH USER PASSWORD';
