...
pub async fn list_handler<Ta, C>(
    user_context: UserContext,
    State(tag_service): State<TagService<Ta, C>>,
...
pub async fn create_handler<Ta, C>(
    user_context: UserContext,
    State(tag_service): State<TagService<Ta, C>>,
...
pub async fn update_handler<Ta, C>(
    user_context: UserContext,
    State(tag_service): State<TagService<Ta, C>>,
    Path(tag_id): Path<TagID>,
...
pub async fn delete_handler<Ta, C>(
    user_context: UserContext,
    State(tag_service): State<TagService<Ta, C>>,
    Path(tag_id): Path<TagID>,
) -> Result<Response, Error>
